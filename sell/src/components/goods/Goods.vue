<template>
  <div>
    <div class="goods">
      ...
      <div class="foods-wrapper" ref="foodsWrapper">
        <ul>
          <li v-for="(item, index) in goods" :key="index" class="food-list food-list-hook">
            ...
            <ul>
              <li v-for="(food, index) in item.foods" :key="index" class="food-item border-1px" @click="selectedFood(food)">
                <div class="icon">
      ...
      <shopcart :selectFoods="selectFoods" :delivery_price="seller.deliveryPrice" :min_price="seller.minPrice"></shopcart>
    </div>
